...
- **VS Code track** — Chat, Plan Mode, Agent Mode, background agents, custom agents/skills/MCP, and editor-native review loops
- **CLI track** — `copilot`, `@file` context, `/plan`, autonomous edits, `/fleet`, `/delegate`, `/review`, and `/agent`, `/skills`, `/mcp`
...
| [06](workshop/06-agents.md) | Specialized Agents & Instructions | Built-in and custom agents, path-scoped instructions |
| [07](workshop/07-skills.md) | Skills | Reusable expertise Copilot loads automatically |
| [08](workshop/08-mcp.md) | MCP Servers | GitHub, browser (Playwright), and live-docs integrations |
| [09](workshop/09-bonus.md) | Bonus & Extensions | Open-ended feature ideas and extra Copilot experiments |
